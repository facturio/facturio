...
class Data_base:
    def __init__(self):
        ...
        self._creation_table_invoice_devis()
        self._creation_table_invoice()
        self._creation_table_art_dev()
        self._creation_table_deposit()
    ...
    def _creation_table_company(self):
        self.cursor.execute("""
            ...
            FOREIGN KEY(id_company) REFERENCES client(id_client) ON DELETE
            CASCADE)""")
    ...
    def _creation_table_invoice_devis(self):
        self.cursor.execute("""
    ...
    def _creation_table_art_dev(self):
        self.cursor.execute("""
            ...
            FOREIGN KEY(id_invoice_devis)
            REFERENCES invoice_devis(id_invoice_devis) ON DELETE CASCADE,
    ...
    def _creation_table_deposit(self):
        self.cursor.execute("""
    ...
    #     self.cursor.execute("""
    #         DELETE FROM"""+name+""" WHERE id_"""+name+"""="""
    #                         +str(id))
    #     self.connexion.commit()

    # def insertion_article(self, liste):
    #     self.cursor.execute("""INSERT INTO article(name,description,price)
    #                             VALUES(?,?,?)""", liste)
    #     self.connexion.commit()
    ...
    #     self.cursor.execute("""
    #     INSERT INTO user(logo,company_name,e_mail,address,phone,business_number) VALUES(?,?,?,?,?,?)""",liste)
    #     self.connexion.commit()
    ...
    #                 """ recuperation de id """
    #                 self.cursor.execute("""INSERT INTO company(id_company,company_name,business_number) VALUES(?,?,?)""",liste_e)
    #                 self.connexion.commit()
    ...
    #     address=?,phone=?,business_number=? WHERE id_user=?""",liste)
    #     self.connexion.commit()
